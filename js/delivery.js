...
const DeliveryManager = {
    ...
    async createChallan(challanData) {
        ...
        const challan = {
            ...
            customerName: challanData.customerName || '',
            customerAddress: challanData.customerAddress || '',
            customerGstin: challanData.customerGstin || '',
            customerPan: challanData.customerPan || '',
            customerPhone: challanData.customerPhone || '',
            referenceNumber: challanData.referenceNumber || '',
            poNumber: challanData.poNumber || challanData.referenceNumber || '',
            narration: challanData.narration || '',
            shipSameAsBilling: challanData.shipSameAsBilling !== false,
            shipToAddress: challanData.shipToAddress || '',
            shipToName: challanData.shipToName || '',
            includeShipToOnPdf: challanData.includeShipToOnPdf !== false,
            destination: challanData.destination || '',
            dispatchDocumentNo: challanData.dispatchDocumentNo || '',
            ...
            equipmentItems: challanData.equipmentItems || [],
            subtotal: 0,
            cgst: 0,
            sgst: 0,
            igst: 0,
            ...
            jobCardId: challanData.jobCardId || null,
